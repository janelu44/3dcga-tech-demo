...
//            customShader.bind();
//        } else {
//            planets["Sun"]->bindShader();
//        }
//        glUniformMatrix4fv(0, 1, GL_FALSE, glm::value_ptr(mvp));
//        glUniformMatrix4fv(1, 1, GL_FALSE, glm::value_ptr(planets["Sun"]->matScale));
//        glUniformMatrix3fv(2, 1, GL_FALSE, glm::value_ptr(planets["Sun"]->getNormalMatrix()));
//        glUniform3fv(5, 1, glm::value_ptr(cameraPos));
//        glUniform3fv(6, 1, glm::value_ptr(lightPos));
//        glUniform3fv(7, 1, glm::value_ptr(planets["Sun"]->baseColor));
//        glUniform1i(8, GL_TRUE);
//        if (planets["Sun"]->colorTexture.has_value()) {
//            planets["Sun"]->colorTexture.value().bind(GL_TEXTURE10);
//            glUniform1i(30, 10);
//        }
//        if (planets["Sun"]->normalTexture.has_value()) {
//            planets["Sun"]->normalTexture.value().bind(GL_TEXTURE11);
//            glUniform1i(31, 11);
//            glUniform1i(32, GL_TRUE);
//        }
//        if (useShadowMap) {
...
//        customShader.bind();
//    } else {
//        planets["Earth"]->bindShader();
//    }
//    glUniformMatrix4fv(0, 1, GL_FALSE, glm::value_ptr(mvp));
//    glUniformMatrix4fv(1, 1, GL_FALSE, glm::value_ptr(planets["Earth"]->matScale));
//    glUniformMatrix3fv(2, 1, GL_FALSE, glm::value_ptr(planets["Earth"]->getNormalMatrix()));
//    glUniform3fv(5, 1, glm::value_ptr(cameraPos));
//    glUniform3fv(6, 1, glm::value_ptr(lightPos));
//    glUniform3fv(7, 1, glm::value_ptr(planets["Earth"]->baseColor));
//    glUniform1i(8, GL_FALSE);
//    if (planets["Earth"]->colorTexture.has_value()) {
//        planets["Earth"]->colorTexture.value().bind(GL_TEXTURE10);
//        glUniform1i(30, 10);
//    }
//    if (planets["Earth"]->normalTexture.has_value()) {
//        planets["Earth"]->normalTexture.value().bind(GL_TEXTURE11);
//        glUniform1i(31, 11);
//        glUniform1i(32, GL_TRUE);
//    }
...
//    }
//    glUniformMatrix4fv(0, 1, GL_FALSE, glm::value_ptr(mvp));
//    glUniformMatrix4fv(1, 1, GL_FALSE, glm::value_ptr(moon.matScale));
//    glUniformMatrix3fv(2, 1, GL_FALSE, glm::value_ptr(moon.getNormalMatrix()));
//    glUniform3fv(6, 1, glm::value_ptr(lightPos));
//    glUniform3fv(7, 1, glm::value_ptr(moon.baseColor));
//    glUniform1i(20, GL_TRUE);
//    if (useShadowMap) {
//        shadowMap.BindForReading(GL_TEXTURE21);
//        glUniform1i(21, 21);
...
//    }
//    glUniformMatrix4fv(0, 1, GL_FALSE, glm::value_ptr(mvp));
//    glUniformMatrix4fv(1, 1, GL_FALSE, glm::value_ptr(mars.matScale));
//    glUniformMatrix3fv(2, 1, GL_FALSE, glm::value_ptr(mars.getNormalMatrix()));
//    glUniform3fv(5, 1, glm::value_ptr(cameraPos));
//    glUniform3fv(6, 1, glm::value_ptr(lightPos));
//    marsTexture.bind(GL_TEXTURE10);
//    glUniform1i(30, 10);
//    marsNormal.bind(GL_TEXTURE11);
//    glUniform1i(31, 11);
//    glUniform1i(32, GL_TRUE);
//    glUniform1i(20, GL_TRUE);
//    if (useShadowMap) {
